...
if page == "🏠 Overview":
    ...
    <div class="hero-banner">
      ...
      <div>
        <span class="hero-chip">📦 5,000 Sainsbury's SKUs</span>
        <span class="hero-chip">📅 Q4 2024 — Oct to Dec</span>
        <span class="hero-chip">🏪 15 Product Categories</span>
    ...
    for _col, _n, _title, _desc in zip(
        ...
        [
            "Synthetic Q4 2024 dataset: 5,000 Sainsbury's SKUs across 15 categories — Dairy, Bakery, Meat, Produce, Wine &amp; Spirits, Baby, Pet Food &amp; more. Daily sales with realistic UK seasonal demand patterns (Halloween, Christmas, Bonfire Night).",
    ...
    <div style="background:#fffae6;border:1px solid #ffe380;border-left:4px solid #F06A00;
      ...
      <span style="font-size:.79rem;color:#5e6c84;margin-left:12px;">
        <strong>Synthetic demo data</strong> — 5,000 Sainsbury's SKUs across 15 categories (Dairy, Bakery, Meat, Produce, Drinks, Grocery, Snacks, Frozen, Household, Health &amp; Beauty, Wine &amp; Spirits, Baby, Pet Food, Free From, World Foods) ·
